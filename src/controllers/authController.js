...
exports.forgotPassword = async (req, res)=>{
  try {
    ...
    const isSent = await sendMail(user.email, 'Password Reset', 'Click here to reset your password: ' + process.env.FRONTEND_URL || 'http://localhost:3000' + '/reset-password?token=' + token  );
    if(!isSent){
